...
from discrete_optimization.generic_tools.do_problem import ModeOptim, Solution
...
class CpSatFacilitySolver(AllocationCpSatSolver[Task, UnaryResource], WarmstartMixin):
